package com.hassan.kooged.agents.imageModeration.screens
...
import com.hassan.kooged.agents.imageModeration.ImageModerationState
import com.hassan.kooged.agents.imageModeration.ImageModerationUiState
...
private fun Preview() {
    Content(
        uiState = ImageModerationUiState(),
        goBack = {},
        checkInput = {},
        onClearClicked = {},
        onTextUpdate = {}
...
@Composable
fun ImageModerationAgentScreen(
    modifier: Modifier = Modifier,
    viewModel: ImageModerationAgentViewModel = koinViewModel(),
    goBack: () -> Unit,
) {
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Paste Image URL to check safety",
                        ...
                        Row(
                            ...
                            Button(
                                onClick = checkInput,
                                enabled = uiState.url.isNotBlank() && uiState.state !is ImageModerationState.Loading,
                            ...
                            OutlinedButton(
                                ...
                                enabled = uiState.state !is ImageModerationState.Loading,
                                modifier = Modifier.weight(1f)
                            ) {
                                Text("Clear")
                            }
                ...
                when (val state = uiState.state) {
                    is ImageModerationState.Loading -> {
                        Card(
                            modifier = Modifier.fillMaxWidth(),
                            elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)
                        ) {
                    ...
                    is ImageModerationState.Result -> {
                        Card(
                            modifier = Modifier.fillMaxWidth(),
                            elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)
                        ) {
                    ...
                    ImageModerationState.Undefined -> {
